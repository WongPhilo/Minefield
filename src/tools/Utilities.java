...
public class Utilities {
    ...
    public static void stepsError(Exception gripe) {
        gripe.printStackTrace();
        JOptionPane.showMessageDialog((Component)null, "# of steps must be a non-negative integer", "OOPS!", 0);
    }
    ...
    public static String getFileName(String fName, Boolean open, String savedName) {
        JFileChooser chooser = new JFileChooser();
        chooser.setSelectedFile(new File(savedName));
        String result = null;
        if (fName != null) {
    ...
    public static String openFileName(String fName, Boolean open) {
        JFileChooser chooser = new JFileChooser();
        String result = null;
        if (fName != null) {
            chooser.setCurrentDirectory(new File(fName));
